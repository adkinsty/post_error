...
dat_sigma %>% 
  ...
  scale_colour_manual("covar", values = WONG[c(4, 7)], labels = c("A", "B")) +
  plot_dens +
  ggsave("fig/sigma_dens.jpg", units = "in", height = 3, width = 4, dpi = 1000)
...
dat_sigma %>% 
  ...
  scale_colour_manual("covar", values = WONG[c(4, 7)], labels = c("A", "B")) +
  plot_phi +
  ggsave("fig/sigma_phi.jpg", units = "in", height = 3, width = 4, dpi = 1000)
...
dat_sigma %>% 
  ...
  plot_theta +
  geom_hline(yintercept = .25, linetype = 'dashed', colour = WONG[1], alpha = .5) +
  ggsave("fig/sigma_theta.jpg", units = "in", height = 3, width = 4, dpi = 1000)
...
dat_beta %>% 
  ...
  scale_colour_manual("covar", values = WONG[c(4, 7)], labels = c("A", "B")) +
  plot_dens +
  ggsave("fig/beta_dens.jpg", units = "in", height = 3, width = 4, dpi = 1000)
...
dat_beta %>% 
  ...
  scale_colour_manual("covar", values = WONG[c(4, 7)], labels = c("A", "B")) +
  plot_phi +
  ggsave("fig/beta_phi.jpg", units = "in", height = 3, width = 4, dpi = 1000)
...
dat_beta %>% 
  ...
  plot_theta +
  geom_hline(yintercept = .25, linetype = 'dashed', colour = WONG[1], alpha = .5) +
  ggsave("fig/beta_theta.jpg", units = "in", height = 3, width = 4, dpi = 1000)
