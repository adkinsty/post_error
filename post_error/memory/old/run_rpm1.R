...
setwd('/Users/adkinsty/Dropbox (University of Michigan)/LeeLab/Experiments/Exp_files/forced_response/post_error/memory/')
...
results <- fit_rpm(dat = dat, exp_name = 'memory', mod_name = 'rpm1_hier', re_run = TRUE)
